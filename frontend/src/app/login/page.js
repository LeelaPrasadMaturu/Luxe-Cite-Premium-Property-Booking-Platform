...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (session) {
      console.log('Current session: logged in successfully', session);
    }
  }, [session]);
      ...
      >
          ...
          >
            <div className="flex items-center">
              <input
                ...
                name="remember-me"
                type="checkbox"
                className="h-4 w-4 text-purple-500 focus:ring-purple-500 border-white/20 bg-white/10 rounded cursor-pointer"
              />
        ...
        >
          <p className="text-sm text-gray-300">
            ...
            <Link href="/register" className="font-medium text-purple-400 hover:text-purple-300 transition-colors duration-200">
              Sign up
            </Link>
          </p>
        </motion.div>
